      ...
      <CardContent>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6} md={3} lg={3}>
            <Box textAlign="center" p={2} bgcolor={(theme) => alpha(theme.palette.text.secondary, 0.1)} borderRadius={2}>
          ...
          <Grid item xs={12} sm={6} md={3} lg={3}>
            <Box textAlign="center" p={2} bgcolor={(theme) => alpha(theme.palette.info.main, 0.1)} borderRadius={2}>
          ...
          <Grid item xs={12} sm={6} md={3} lg={3}>
            <Box textAlign="center" p={2} bgcolor={(theme) => alpha(theme.palette.warning.main, 0.1)} borderRadius={2}>
          ...
          <Grid item xs={12} sm={6} md={3} lg={3}>
            <Box textAlign="center" p={2} bgcolor={(theme) => alpha(theme.palette.secondary.main, 0.1)} borderRadius={2}>
          ...
          <Grid item xs={12} sm={6} md={3} lg={3}>
            <Box textAlign="center" p={2} bgcolor={(theme) => alpha(theme.palette.success.main, 0.1)} borderRadius={2}>
          ...
          <Grid item xs={12} sm={6} md={3} lg={3}>
            <Box textAlign="center" p={2} bgcolor={(theme) => alpha(theme.palette.text.disabled, 0.1)} borderRadius={2}>
          ...
          <Grid item xs={12} sm={6} md={3} lg={3}>
            <Box textAlign="center" p={2} bgcolor={(theme) => alpha(theme.palette.info.light, 0.1)} borderRadius={2}>
              <AcUnitIcon sx={{ color: 'info.light', mb: 1 }} />
          ...
          <Grid item xs={12} sm={6} md={3} lg={3}>
            <Box textAlign="center" p={2} bgcolor={(theme) => alpha(theme.palette.error.main, 0.1)} borderRadius={2}>
