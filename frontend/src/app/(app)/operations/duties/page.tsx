...
export default function DutiesPage() {
  ...
  const [data, setData] = useState<any>({ dashboard: [], rotation: [], roster: [], logs: EMPTY_PAGE, exceptions: EMPTY_PAGE, reservations: EMPTY_PAGE, map: {} });
